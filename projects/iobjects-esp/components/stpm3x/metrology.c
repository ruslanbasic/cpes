...
{
  const METRO_Device_Config_t zero1 = {0};
  const METRO_Data_Energy_t zero2 = {0};

  Tab_METRO_internal_Devices_Config[EXT1] = zero1;
  METRO_Data = zero2;
